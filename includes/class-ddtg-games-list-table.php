...
class DDTG_Games_List_Table extends WP_List_Table {
    ...
    public function column_default( $item, $column_name ) {
        switch ( $column_name ) {
            ...
            case 'actions':
                $edit_url = admin_url( 'admin.php?page=ddtg-create-game&action=edit&game_id=' . $item->game_id );
                $results_url = admin_url( 'admin.php?page=ddtg-game-results&game_id=' . $item->game_id );
